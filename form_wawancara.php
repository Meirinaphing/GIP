		...
		<form class="form-horizontal" action="#">
			<div class="form-group">
				...
				<div class="col-md-4 col-sm-4">
					<input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Pelamar">
				</div>
				<label class="control-label col-sm-2 col-md-2">Divisi/Dept:</label>
				<div class="col-md-4 col-sm-4">
					<input type="text" class="form-control" name="divisi" id="divisi" placeholder="Masukkan Divisi">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-2 col-md-2">Kelas Jabatan:</label>
				<div class="col-md-4 col-sm-4">
