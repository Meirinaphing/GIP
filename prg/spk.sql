...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2018 at 05:57 AM
...
('', 'admin', '2018-10-01', '', '', '', 0, 0, '', 'file_p_kariawan/aNLv6', '', 0, '', 0, '', '', 0, '', 0, 0, '', '', 0, '', 0, '', 0, 'Submited'),
('3009-1-0', 'admin', '2018-09-30', 'Admin', '123', '123', 12, 12, 'no', 'promosi', 'bulanan', 0, '23', 23, 'sd', 'tidakpengalaman', 0, '12', 0, 0, '', '09', 9, '09', 9, '09', 9, 'Approved');
...
(2, 'a', 'leader', 'aemail', '7815696ecbf1c96e6894b779456d330e', 'a', ''),
...
--
ALTER TABLE `isibobot`
  MODIFY `noisi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
...
--
ALTER TABLE `lowker`
  MODIFY `idlowker` int(11) NOT NULL AUTO_INCREMENT;
--
