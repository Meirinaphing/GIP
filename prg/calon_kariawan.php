							...
							<tbody>
								...
								foreach ($query as $row) {
									...
									<tr>
										...
										<td>
											<button <?php echo $field; ?> data-toggle="modal" data-target="#myModal" id="view" class="btn btn-primary fa fa-envelope" title="Email" onclick="modal_reload('<?= $idpelamar?>')"></button><button onclick="reject('<?= $idpelamar?>')" id="reject" class="btn btn-danger fa fa-close" title="Reject"></button>
										</td>
									</tr>
									<?php
									$field="";
