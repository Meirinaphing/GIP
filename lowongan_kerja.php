...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
          ...
          <li class="nav-item">
          	<a href="form_hr.php" class="nav-link">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<button class="btn btn-primary fa fa-file" title="Edit" style="margin-bottom: 20px;"> Create</button>
						<table id="example2" class="table table-bordered table-hover">
							...
							<tbody>
								<tr>
									...
									<td>X</td>
									<td>
										<button class="btn btn-info fa fa-edit" title="Edit"></button>
										<button class="btn btn-danger fa fa-remove" title="Delete"></button>
									</td>
								</tr>
							</tbody>
							<tfoot>
